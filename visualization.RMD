...
#cell_type_colors = c('magenta2','darkorchid1','darkorchid4','gold','darkgoldenrod','brown','darkturquoise','paleturquoise','green3','forestgreen','black','gray')
...
```
```{r}
VlnPlot(so.mouse.EC, split.by = 'orig.ident', features = c('Cav2'))
```
